...
int main() {
    ...
    left_wall.transform(Transform::translate(0.0f, 0.0f, 5.0f) * Transform::rotate_y(-M_PI / 4.0f) * Transform::rotate_x(M_PI / 2.0f) * Transform::scale(10.0f, 0.01f, 10.0f));

    Sphere right_wall = Sphere();
    right_wall.material = floor.material;
    right_wall.transform(Transform::translate(0.0f, 0.0f, 5.0f) * Transform::rotate_y(M_PI / 4.0f) * Transform::rotate_x(M_PI / 2.0f) * Transform::scale(10.0f, 0.01f, 10.0f));
    ...
    right.transform(Transform::translate(1.5f, 0.5f, -0.5f) * Transform::scale(0.5f, 0.5f, 0.5f));

    Sphere left = Sphere();
    left.material.color = Color(1.0f, 0.8f, 0.1f);
    left.material.diffuse = 0.7f;
    left.material.specular = 0.3f;
    left.transform(Transform::translate(-1.5f, 0.33f, -0.75f) * Transform::scale(0.33f, 0.33f, 0.33f));
